...
public class FlightPlanner extends ConsoleProgram {
	...
	public void run() {
		...
		readFlightData("/Users/penprapacalhoun/Desktop/Stanford106AAssignments-2/src/flight.txt");
	...
	/**
	 * Given a starting city, looks up the destinations from that city in the
	 * HashMap of flights, and return an array list of the destinations that are
	 * available.
	 */
	...
	/**
	 * Prints a list of cities from the array list. Each city name is indented by a
	 * space.
	 */
	...
	private void readFlightData(String filename) {
		...
		try {
			BufferedReader rd = new BufferedReader(new FileReader("/Users/penprapacalhoun/Desktop/Stanford106AAssignments-2/src/flight.txt"));
			while (true) {
	...
	/**
	 * Reads a single flight entry from the line passed as an argument, which should
	 * be in the form
	 *
	 * fromCity -> toCity
	 *
	 * Each new city is added to the ArrayList cities, and each new flight is
	 * recorded by adding a new destination city to the ArrayList stored in the
	 * HashMap flights under the key for the starting city.
	 */
